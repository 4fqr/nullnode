...
- New learning content: a single interactive "Learning Content" page with ground-up, chapter-by-chapter explanations and safe, hands-on exercises in the built-in simulated terminal.
